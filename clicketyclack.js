...
// STARTER MONEY
	...
	asset.add('piggyback','Give Piggy Back Ride',"Gotta start somewhere.\n +$100",0,'prerail',false,{resource:'bank',count:100,inc:0},true,[],[],[],[]);
	asset.add('push','Push Wagon',"Goes faster with a push.\n +$200",0,'prerail',false,{resource:'bank',count:200,inc:0},false,[],[],[],[{cat:'asset',name:'wagon-1',type:'rollingstock',count:1}]);
